...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen py-12 max-w-full overflow-hidden">
        {/* Background */}
          ...
          {!bgImageError && (
            <div className="absolute inset-0 w-full h-full left-0 right-0">
              <Image
                ...
                fill
                className="object-cover object-center w-full h-full mix-blend-overlay opacity-60"
                sizes="100vw"
