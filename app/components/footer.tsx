        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex justify-center md:justify-start gap-6">
                {socialLinks.map((item) => (
                  <Link
                    ...
                    className="text-[#C8A97E] hover:text-[#B69A6E] transition-colors flex items-center justify-center"
            ...
            <div className="flex flex-col justify-start items-center md:items-end w-full">
              <div className="flex items-center justify-center md:justify-end gap-6 mb-4 w-full">
              ...
              <div className="w-36 h-20 relative flex justify-center md:justify-end">
                <Image
                  src={process.env.NODE_ENV === 'production' ? '/vocal-coaching/images/footer/footer.png' : '/images/footer/footer.png'}
                  alt="Footer decoration"
                  width={144}
                  height={80}
                  className="object-contain filter brightness-0 invert transform translate-y-2 md:-translate-x-8"
                  priority
                />
              </div>
            </div>
            ...
            <div className="relative w-full h-full flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 pt-2.5 pb-0.5 border-b border-[#C8A97E]/20">
                  ...
                  <button
                    onClick={handleCloseModal}
                    className="absolute right-5 top-3 p-1.5 rounded-lg transition-colors bg-transparent hover:bg-[#1A1A1A]/50 z-50 w-8 h-8 flex items-center justify-center"
                  >
                    <span style={{color: "#C8A97E", fontSize: "18px", fontWeight: "bold"}}>X</span>
                  </button>
                </div>
