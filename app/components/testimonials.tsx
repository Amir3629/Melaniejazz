            ...
            >
              <div className="flex items-center mb-6">
                <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-[#C8A97E]/20">
                  {
                    (() => {
                      const imagePath = getImagePath(testimonial.image)
                      console.log(`Rendering image for ${testimonial.name}: Path - ${imagePath}`)
                      return (
                        <Image
                          src={imagePath}
                          ...
                          sizes="64px"
                          onError={(e) => console.error(`Error loading image for ${testimonial.name}:`, e)}
                        />
                      )
                    })()
                  }
