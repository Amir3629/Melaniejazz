  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-9 w-9 bg-transparent flex items-center justify-center text-[#C8A97E] hover:text-[#D4AF37] transition-colors"
        ),
      ...
      components={{
        IconLeft: () => (
          <span className="text-lg font-medium text-[#C8A97E] hover:text-[#D4AF37]">&lt;</span>
        ),
        IconRight: () => (
          <span className="text-lg font-medium text-[#C8A97E] hover:text-[#D4AF37]">&gt;</span>
        ),
