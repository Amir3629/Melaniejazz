      ...
      <section id="hero" ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <Button 
              size="lg" 
              className="bg-[#C8A97E] hover:bg-[#B89A6F] text-black border-2 border-[#C8A97E] hover:border-[#B89A6F] rounded-full px-8 transition-all duration-300 py-2 text-base w-[180px] mx-auto"
              onClick={() => {
      ...
      <section id="services" className="relative w-full py-16 bg-[#040202]">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <Button 
              size="lg"
              className="bg-[#C8A97E] hover:bg-[#B89A6F] text-black rounded-full px-8 py-2 text-base w-[180px] mx-auto border-2 border-[#C8A97E] hover:border-[#B89A6F] transition-all duration-300"
